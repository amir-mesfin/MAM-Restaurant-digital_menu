    ...
    <div className=''>
      ...
      <form className='max-w-3xl mx-auto flex flex-col space-y-7' onSubmit={handleSubmit}>
        <div className='flex flex-col space-y-1.5'>
          ...
          <input
            type="text"
            className={`p-3 ml-3 bg-white rounded-lg border focus:outline-none focus:ring-2 ${errors.foodName ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-amber-500'
              }`}
            id='foodName'
        ...
        <div className='flex flex-col space-y-1.5'>
          ...
          <textarea
            className={`p-3  ml-3 bg-white rounded-lg border focus:outline-none focus:ring-2 ${errors.foodDescription ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-amber-500'
              }`}
            id="foodDescription"
        ...
        <div className='flex flex-col space-y-1.5'>
          ...
          <input
            type="number"
            className={`p-3 rounded-lg  ml-3 bg-white border focus:outline-none focus:ring-2 ${errors.foodPrice ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-amber-500'
              }`}
            id="foodPrice"
          ...
          <div className='flex flex-col sm:flex-row gap-4 items-start'>
            <div className='flex-1'>
              <input
                ...
                className={`w-full p-2 border ml-3 bg-white rounded-lg file:mr-3 file:py-2 file:px-4 file:rounded file:border-0 file:text-sm file:font-medium file:bg-amber-50 file:text-amber-700 hover:file:bg-amber-100 ${errors.image ? 'border-red-500' : 'border-gray-300'
                  }`}
                accept="image/*"
              />
        ...
        <div className="flex flex-col space-y-1.5">
          ...
          <select
            className={`p-3 rounded-lg border focus:outline-none ml-3 bg-white focus:ring-2 ${errors.foodCategory ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-amber-500'
              }`}
            id="foodCategory"
        ...
        <button
          ...
          className={`py-3 px-6 rounded-lg font-medium text-white ${isSubmitting || loadingImg ? 'bg-gray-400 cursor-not-allowed' : 'bg-amber-600 hover:bg-amber-700'
            }`}
        >
